...
@section('content')
    ...
    <div class="card mx-auto col-lg-8 mt-4 px-0">
        ...
        <div class="card-header shadow rounded" style="background:#21556A;">
            <h2 class="text-white" style="padding-left:25px;"><b>Edit Seminar Items</b></h2>
        </div>
